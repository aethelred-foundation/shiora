...
const PATHWAY_DEFS: PathwayDef[] = [
  {
    ...
    description:
      'Comprehensive Type 2 Diabetes management pathway based on ADA Standards of Care 2024, covering initial evaluation through ongoing monitoring and treatment intensification.',
    ...
    steps: [
      {
        ...
        description:
          'Obtain baseline HbA1c, fasting glucose, lipid panel, and comprehensive metabolic panel. Assess BMI, blood pressure, and comorbidities.',
      ...
      },
      {
        ...
        description:
          'Prescribe medical nutrition therapy and structured exercise program. Target 150 min/week moderate-intensity activity and 5-7% weight loss.',
        action: 'Refer to certified diabetes educator and dietitian',
        status: 'completed',
        criteria: [
          'Initial assessment completed',
          'Patient willing to engage',
      ...
      },
      {
        ...
        description:
          'Start metformin 500mg daily with meals. Titrate to 1000mg BID over 4 weeks if tolerated. Monitor GI side effects and renal function.',
        action: 'Prescribe metformin 500mg daily, titrate per protocol',
        status: 'active',
        criteria: [
          'eGFR >= 30 mL/min',
          'No lactic acidosis history',
          'Lifestyle modification initiated',
        ],
      },
      {
        title: 'Quarterly HbA1c Monitoring',
        description:
          'Repeat HbA1c every 3 months until stable at target (< 7.0%). Adjust therapy if HbA1c not at goal after 3 months of current regimen.',
      ...
      },
      {
        ...
        description:
          'If HbA1c remains above target, add second agent (SGLT2i or GLP-1 RA preferred for cardiovascular benefit). Consider insulin if HbA1c > 10%.',
        action: 'Evaluate for add-on therapy per ADA algorithm',
        status: 'pending',
        criteria: [
          'HbA1c above target after 3 months',
          'Adherence verified',
  ...
  },
  {
    ...
    description:
      'Evidence-based hypertension management pathway aligned with ACC/AHA 2017 guidelines, targeting BP < 130/80 mmHg for high-risk patients.',
    ...
    steps: [
      {
        ...
        description:
          'Confirm elevated BP with ambulatory blood pressure monitoring (ABPM) or home BP monitoring over 2 weeks. Rule out white coat effect.',
      ...
      },
      {
        ...
        description:
          'Calculate 10-year ASCVD risk score. Obtain ECG, renal function, lipid panel, and fasting glucose. Screen for secondary causes if age < 30.',
      ...
      },
      {
        ...
        description:
          'Initiate ACE inhibitor (lisinopril 10mg) or ARB (losartan 50mg) if ACEi intolerant. For Black patients, prefer CCB (amlodipine 5mg) or thiazide.',
        action: 'Prescribe lisinopril 10mg daily or appropriate alternative',
        status: 'active',
        criteria: [
          'Stage 1 HTN with ASCVD risk >= 10%',
          'Or Stage 2 HTN (BP >= 140/90)',
          'No contraindications to ACEi',
        ],
      },
      {
        title: 'Follow-Up Titration',
        description:
          'Reassess BP in 4 weeks. If not at goal, uptitrate current agent or add second agent from different class. Target < 130/80.',
      ...
      },
      {
        ...
        description:
          'If BP not controlled on dual therapy, add third agent. Consider referral to hypertension specialist if resistant (BP uncontrolled on 3 agents).',
  ...
  },
  {
    ...
    description:
      'Comprehensive prenatal care protocol following ACOG guidelines, covering initial booking visit through delivery planning with integrated risk assessment.',
    ...
    steps: [
      {
        ...
        description:
          'Complete medical history, physical examination, and baseline labs. Order CBC, blood type/Rh, rubella immunity, hepatitis B, HIV, urinalysis, and dating ultrasound.',
        action: 'Schedule comprehensive first visit with full lab panel',
        status: 'completed',
        criteria: [
          'Positive pregnancy test',
          'Estimated 8-10 weeks gestation',
      ...
      },
      {
        ...
        description:
          'Offer combined first-trimester screening (nuchal translucency ultrasound + serum markers) or cell-free DNA screening for chromosomal abnormalities.',
      ...
      },
      {
        ...
        description:
          'Perform detailed fetal anatomy ultrasound. Screen for gestational diabetes with 1-hour glucose challenge test. Assess placental position.',
      ...
      },
      {
        ...
        description:
          'Administer Rh immunoglobulin if Rh-negative. Initiate biweekly visits. Screen for Group B Streptococcus at 36 weeks. Monitor fetal growth.',
      ...
      },
      {
        ...
        description:
          'Develop birth plan with patient. Assess fetal presentation and cervical status. Discuss induction indications and timing. Schedule delivery if indicated.',
