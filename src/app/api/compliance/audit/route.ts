...
import { seededInt, seededHex, seededPick, seededAddress, generateAttestation } from '@/lib/utils';
...
const RESOURCES = [
  ...
  'grant-5b9cd2e3f4a5',
  'key-6c0de3f4a5b6',
  'consent-7d1ef4a5b6c7',
  'report-8e2fa5b6c7d8',
  'tee-9f3ab6c7d8e9',
  'session-0a4bc7d8e9f0',
  'export-1b5cd8e9f0a1',
  'privacy-2c6de9f0a1b2',
  'scan-3d7ef0a1b2c3',
  'vault-4e8fa1b2c3d4',
  'pipeline-5f9ab2c3d4e5',
  'transfer-6a0bc3d4e5f6',
  'incident-7b1cd4e5f6a7',
  'backup-8c2de5f6a7b8',
  'auth-9d3ef6a7b8c9',
  'rate-0e4fa7b8c9d0',
  'anon-1f5ab8c9d0e1',
  'border-2a6bc9d0e1f2',
  'response-3b7cd0e1f2a3',
] as const;
  ...
  try {
    ...
    const entries = Array.from({ length: limit }, (_, i) => {
      ...
      return {
        ...
        frameworkRelevance: [
          seededPick(SEED + idx * 57, ['hipaa', 'gdpr', 'soc2', 'hitrust', 'fda_21cfr11'] as const),
        ],
