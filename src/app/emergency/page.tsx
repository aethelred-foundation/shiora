 ...
 * library, structured triage, and care handoff tracking with
...
const DEFAULT_TRIAGE = {
  ...
  reasoning:
    "Based on the reported symptoms (Chest tightness, Shortness of breath, Dizziness), the triage reference workflow assessed the patient's condition using the Emergency Severity Index (ESI). Critical symptoms detected requiring emergent evaluation. Elevated heart rate and blood pressure support the urgency classification. This assessment was processed within a TEE enclave for privacy and verified through on-chain attestation.",
  confidence: 94,
  attestation: generateAttestation(SEED + 500),
  assessedAt: Date.now() - 3600000,
  modelId: 'triage-reference-v2.1',
};
          ...
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-8">
            <div>
              ...
              <p className="text-sm text-slate-500">
                Emergency medical information, care team management, and structured triage with TEE
                attestations
              </p>
            </div>
