 ...
 *
 * Clinical pathways, drug interaction checks, differential
          ...
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-8">
            <div>
              ...
              <p className="text-sm text-slate-500">
                Clinical pathways, drug interaction checks, and differential diagnosis with
                TEE-verified audit trail
              </p>
            </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div>
          <SectionHeader
            ...
            subtitle="Decision-support accuracy across clinical categories"
            size="sm"
            icon={BarChart3}
          />
          <MedicalCard>
  ...
  return (
    <div>
      <SectionHeader
        ...
        subtitle="Decision-support differential diagnoses ranked by probability with TEE attestation"
        size="sm"
        icon={Brain}
      />
  ...
  return (
    <div>
      <SectionHeader
        ...
        subtitle="Immutable, TEE-attested record of all clinical decision-support outcomes"
        size="sm"
        icon={ScrollText}
      />
