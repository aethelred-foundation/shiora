...
export const metadata: Metadata = {
  ...
  description:
    "Women's Health Data Platform on the Aethelred Blockchain — encrypted, owner-controlled, and access-audited privacy for sensitive health data.",
  ...
  openGraph: {
    ...
    description: "Women's Health Data Platform on the Aethelred Blockchain",
