...
function makeDefaultMock(
  overrides: Partial<ReturnType<typeof useWearables>> = {},
): ReturnType<typeof useWearables> {
  const devices = [
    {
      id: 'd1',
    ...
    syncBatches: [
      {
        ...
        dataPointCount: 120,
        attestation: '0xabc123def456789012345678',
        status: 'completed' as const,
      },
      {
        id: 'sb2',
        deviceId: 'd2',
        syncedAt: Date.now() - 7200000,
        dataPointCount: 85,
        attestation: '0xdef456abc789012345678901',
        status: 'completed' as const,
      },
    ],
    isLoading: false,
...
describe('WearablesPage', () => {
  ...
  it('renders the page description', () => {
    ...
    expect(screen.getByText(/Connect wearable devices and sync health data/)).toBeInTheDocument();
  });
  ...
  it('hides data visualization when no devices are connected', () => {
    mockUseWearables.mockReturnValue(
      makeDefaultMock({
        devices: [
          {
            id: 'd1',
