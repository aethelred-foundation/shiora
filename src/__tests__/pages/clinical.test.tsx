...
describe('ClinicalDecisionSupportPage', () => {
  ...
  it('renders the page description', () => {
    ...
    expect(
      screen.getByText(/Clinical pathways, drug interaction checks, and differential diagnosis/),
    ).toBeInTheDocument();
  });
  ...
  it('switches to Differentials tab', () => {
    ...
    expect(screen.getByText(/Decision-support differential diagnoses/)).toBeInTheDocument();
  });
