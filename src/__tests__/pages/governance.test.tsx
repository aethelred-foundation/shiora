...
jest.mock('@/hooks/useGovernance', () => ({
  useGovernance: () => ({
    proposals: [
      {
        id: 'prop-1',
        title: 'Increase minimum staking amount to 500 AETHEL',
        type: 'parameter',
        status: 'active',
        forVotes: 5000,
        againstVotes: 1200,
      ...
      {
        id: 'prop-2',
        title: 'Treasury allocation for Q2 grants',
        type: 'treasury',
        status: 'passed',
        forVotes: 8000,
        againstVotes: 500,
      ...
      {
        id: 'prop-3',
        title: 'Add new inference workload support',
        type: 'feature',
        status: 'defeated',
        forVotes: 2000,
        againstVotes: 6000,
    ...
    delegations: [
      {
        ...
        delegatee: 'aeth1xyz0000000000000000000000000000000000',
        votingPower: 3000,
      ...
      {
        id: 'd-2',
        delegator: 'aeth1aaa0000000000000000000000000000000000',
        delegatee: 'aeth1bbb0000000000000000000000000000000000',
        votingPower: 1500,
        delegatedAt: Date.now(),
        txHash: '0xdef456',
      },
  ...
  useStaking: () => ({
    ...
    positions: [
      ...
      },
      {
        ...
        amount: 10000,
        status: 'unstaking',
        stakedAt: Date.now() - 86400000 * 60,
        rewardsEarned: 600,
        rewardsClaimed: 600,
        unlockAt: Date.now() + 86400000 * 7,
      },
    ],
    rewards: [
      {
      ...
      },
      {
        id: 'r-2',
        amount: 150,
        source: 'governance_bonus',
        earnedAt: Date.now() - 86400000 * 2,
        claimedAt: null,
      },
    ],
    stake: mockStake,
...
describe('GovernancePage', () => {
  ...
  it('switches to My Votes tab', () => {
    ...
    expect(screen.getByText(/Your past votes on protocol proposals/)).toBeInTheDocument();
  });
  ...
  it('clicks status filter buttons on proposals tab', () => {
    ...
    const filterBtn = activeButtons.find((el) =>
      el.closest('button')?.className?.includes('rounded-full'),
    );
