    ...
    auditLog: [
      {
        ...
        riskLevel: 'low',
        timestamp: Date.now(),
        teeAttestation: '0xabc123def456',
        details: 'Login from IP',
        ipAddress: '10.0.0.1',
        frameworkRelevance: ['hipaa'],
      },
      {
        id: 'a-2',
        action: 'data_export',
        ...
        riskLevel: 'medium',
        timestamp: Date.now(),
        teeAttestation: '0xdef456abc123',
        details: 'Export records',
        ipAddress: '10.0.0.2',
        frameworkRelevance: ['gdpr'],
      },
      {
        id: 'a-3',
        ...
        riskLevel: 'high',
        timestamp: Date.now(),
        teeAttestation: '0x123abc456def',
        details: 'Config updated',
        ipAddress: '10.0.0.3',
        frameworkRelevance: ['soc2'],
      },
    ],
    ...
    violations: [
      {
        ...
        remediationPlan: 'Update encryption',
      },
      {
        id: 'v-2',
        frameworkId: 'gdpr',
        ...
        detectedAt: Date.now(),
        assignedTo: 'Legal',
        remediationPlan: 'Update consent flows',
      },
      {
        id: 'v-3',
        frameworkId: 'soc2',
        ...
        detectedAt: Date.now(),
        assignedTo: 'IT Ops',
        remediationPlan: 'Complete review',
      },
      {
        id: 'v-4',
        frameworkId: 'hipaa',
...
describe('CompliancePage', () => {
  ...
  it('expands and collapses a framework on frameworks tab', () => {
    ...
    const clickableHeader = hipaaHeaders.find((el) => el.closest('button'));
    if (clickableHeader) {
    ...
    const gdprClickable = gdprHeaders.find((el) => el.closest('button'));
    if (gdprClickable) {
  ...
  it('renders upcoming assessment with unknown framework ID', () => {
    mockOverrides = {
      overview: {
        ...
        upcomingAssessments: [{ frameworkId: 'unknown_fw', dueDate: Date.now() + 86400000 * 30 }],
        complianceTrend: [],
      },
    };
    render(
