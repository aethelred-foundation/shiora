...
/**
 * Tests for src/proxy.ts — the Next.js Proxy entrypoint that handles
...
describe('proxy — OPTIONS preflight', () => {
...
describe('proxy — mutating methods with disallowed origin', () => {
...
describe('proxy — GET /api route (createApiResponse)', () => {
