...
describe('ChatBubble', () => {
  ...
  it('renders model badge for assistant messages', () => {
    ...
    expect(screen.getByText('Clinical Reference v3')).toBeInTheDocument();
  });
...
describe('ChatInput', () => {
  ...
  it('calls onSend when send button clicked with text', () => {
    ...
    const textarea = screen.getByPlaceholderText('Ask your health assistant...');
