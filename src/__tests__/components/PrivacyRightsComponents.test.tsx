...
const mockRequest: PrivacyRequest = {
  ...
  type: 'access',
  status: 'completed',
  details: 'Request for all health records and verified inference logs.',
  dataCategories: ['Health Records', 'Verified Inferences'],
...
describe('PrivacyRequestCard', () => {
  ...
  it('renders details and data categories', () => {
    ...
    expect(screen.getByText('Verified Inferences')).toBeInTheDocument();
  });
