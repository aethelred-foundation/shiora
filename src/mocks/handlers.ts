...
export const handlers = [
  ...
  http.get('*/api/xai/shap', () =>
    ok({
      ...
      confidence: 96.2,
      explanation:
        'The model predicts normal ovulation timing based primarily on consistent cycle length and clear temperature shift.',
    }),
  ),
    ...
    ok([
      {
        ...
        name: 'Cycle LSTM',
        version: 'v2.1',
        description: 'Predicts menstrual cycle timing using LSTM neural network.',
        architecture: 'LSTM',
        ...
        intendedUse: 'Menstrual cycle timing prediction',
      ...
      },
      {
        ...
        version: 'v1.4',
        description: 'Detects unusual health patterns using Isolation Forest.',
