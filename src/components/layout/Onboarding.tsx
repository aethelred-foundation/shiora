  ...
  return (
    <div className="text-center">
      ...
      <p className="text-base text-slate-500 max-w-md mx-auto mb-8">
        Your sovereign health data platform powered by TEE-verified inference on the Aethelred
        blockchain.
      </p>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 max-w-xl mx-auto">
        ...
        <div className="p-4 bg-emerald-50 rounded-xl">
          ...
          <p className="text-xs text-slate-500 mt-1">
            Sensitive workloads run inside secure hardware enclaves
          </p>
        </div>
...
function StepConnectWallet({
  ...
  connectWallet: (provider?: WalletProvider) => void | Promise<void>;
}) {
  return (
    <div className="text-center">
...
function StepTEEPreference() {
  ...
  return (
    <div className="text-center">
      ...
      <p className="text-sm text-slate-500 max-w-md mx-auto mb-8">
        Select the Trusted Execution Environment for your confidential health computations. All
        sensitive workloads run exclusively inside these secure enclaves.
      </p>
  ...
  return (
    <div className="text-center">
      ...
      <p className="text-base text-slate-500 max-w-md mx-auto mb-8">
        ...
        end-to-end encryption and TEE-verified inference on the Aethelred blockchain.
      </p>
