      ...
      <MedicalCard>
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="text-sm font-semibold text-slate-900">Select Inference Workload</p>
              <p className="text-xs text-slate-400">
                Choose a workload to view its explainability details
              </p>
            </div>
          </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          <MedicalCard>
            <div className="flex items-center gap-2 mb-3">
              ...
              <h4 className="text-sm font-semibold text-slate-900">Inference Explanation</h4>
            </div>
        ...
        <div className="flex items-start gap-3">
          ...
          <div>
            <h4 className="text-sm font-semibold text-violet-900 mb-1">
              About Inference Explainability
            </h4>
            <p className="text-sm text-violet-700">
              Configured inference workloads produce explainability artifacts including SHAP values,
